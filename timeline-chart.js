//link do github https://github.com/commodityvectors/d3-timeline
class TimelineChart {
    constructor(element, data, opts) {
        ...
        let intervals = groupIntervalItems
            ...
            //.attr('width', (d) => x(d.to) - x(d.from)) //customizacao minha. desabilitada
        ...
        function zoomed() {
            ...
            //svg.selectAll('rect.interval').attr('x', d => x(d.from)).attr('width', d => x(d.to) - x(d.from));  //customizacao minha. desabilitada
